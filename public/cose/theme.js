...
(function(){
  ...
  // Headingless page (e.g. a single-page app / tool): there's no document map,
  // so drop the "On this page" tab and show the cross-site map instead.
  if(!links.length){ tabDoc.style.display = "none"; savedPanel = "site"; }
