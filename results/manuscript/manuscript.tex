...
gas exchange and stress signatures of spaceflight-grown plants\citep{kitaya2003,porterfield2002,barker2023}, and it is
...
Notably, a meta-analysis of 15 \textit{Arabidopsis} spaceflight transcriptome experiments found that flight
hardware and lighting impose some of the largest confounding effects on the response, with hypoxia and
oxidative-stress signatures among its conserved features\citep{barker2023}; the present model provides a
physical basis for that hardware dependence, and its BRIC-specific \oo{} drawdown (\S3.7) is consistent with
the hypoxia signatures reported for sealed-canister experiments.
...
\bibitem{barker2023} Barker, R., Kruse, C.~P.~S., Johnson, C., Saravia-Butler, A., Fogle, H., Chang, H.-S., Trane, R.~M., Kinscherf, N., Villacampa, A., Manzano, A., Herranz, R., Davin, L.~B., Lewis, N.~G., Perera, I., Wolverton, C., Gupta, P., Jaiswal, P., Reinsch, S.~S., Wyatt, S. \& Gilroy, S. Meta-analysis of the space flight and microgravity response of the \textit{Arabidopsis} plant transcriptome. \textit{npj Microgravity} \textbf{9}, 21 (2023). doi:10.1038/s41526-023-00247-6.
\end{thebibliography}
