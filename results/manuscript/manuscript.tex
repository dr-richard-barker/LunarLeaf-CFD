...
gas exchange and stress signatures of spaceflight-grown plants\citep{kitaya2003,porterfield2002,musgrave}, and it is
...
\ref{fig:hwscale}). \textbf{BRIC}---hermetically sealed\citep{paul2013}---imposes zero-flux walls: the enclosure
...
experiments\citep{paul2013,parafilm}, complementary to gravisensing- and light-driven responses\citep{cara}.
...
\bibitem{kitaya2003} Kitaya, Y. \textit{et al.} Gas exchange and boundary-layer resistance of plant leaves under altered gravity and forced convection. \textit{Adv. Space Res.} (2003).
\bibitem{porterfield2002} Porterfield, D.~M. The biophysical limitations in physiological transport and exchange in plants grown in microgravity. \textit{Ann. Bot.} (2002).
\bibitem{musgrave} Musgrave, M.~E. \textit{et al.} Gas exchange and plant metabolism in the spaceflight environment. \textit{Plant Physiol.} (review).
\bibitem{ghia1982} Ghia, U., Ghia, K.~N. \& Shin, C.~T. High-Re solutions for incompressible flow using the Navier--Stokes equations and a multigrid method. \textit{J. Comput. Phys.} \textbf{48}, 387--411 (1982).
\bibitem{devahldavis1983} de Vahl Davis, G. Natural convection of air in a square cavity: a benchmark numerical solution. \textit{Int. J. Numer. Methods Fluids} \textbf{3}, 249--264 (1983).
\bibitem{chew2017} Chew, Y.~H., Millar, A.~J. \textit{et al.} Whole-plant-chamber carbon-balance dataset for \textit{Arabidopsis thaliana}. \textit{bioRxiv} (2017) and associated data workbook.
\bibitem{paul2013} Paul, A.-L. \textit{et al.} Organ-specific remodeling of the \textit{Arabidopsis} transcriptome in response to spaceflight (BRIC hardware). \textit{BMC Plant Biol.} (2013). PMC3750915.
\bibitem{sealingfilm} Beware of sealing film of Petri dishes! --- sealing method alters the expression of a large number of genes; surgical tape maintains near-ambient \co/\oo. PMC12193506.
\bibitem{parafilm} Plants grown in parafilm-wrapped Petri dishes are stressed and possess altered gene-expression profiles. PMC6529517.
\bibitem{cara} Light has a principal role in the \textit{Arabidopsis} transcriptomic response to the spaceflight environment (CARA). PMC11303767.
\end{thebibliography}
